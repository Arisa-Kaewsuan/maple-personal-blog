      ...
      <header className='w-full h-12 md:h-20 flex justify-between items-center px-6 md:px-[7.5rem] py-3 md:py-[1.125rem] border-b-2 border-b-brown-300'>
            ...
            <div>
                ...
                <div className='hidden md:flex text-b1 font-medium'>
                    <Link to={"/login"}><div className='px-10 py-3 rounded-full border-2 border-brown-400'>Log in</div></Link>
                    <Link to={"/signup"}><div className='px-10 py-3 ml-2 rounded-full bg-brown-600 text-white'>Sign up</div></Link>
                </div>
            </div>
      </header>
    </>
